...
/* Official AZ-900 "Skills at a glance" sections. Every question carries a
   "domain" (1-3). */
const DOMAINS = {
  1: { num: "1", name: "Describe cloud concepts", weight: "25–30%" },
  2: { num: "2", name: "Describe Azure architecture and services", weight: "35–40%" },
  3: { num: "3", name: "Describe Azure management and governance", weight: "30–35%" },
};
...
function openFlashSetup() {
  ...
  els.flashSetupLead.innerHTML =
    ...
    `AZ-900 questions. Read the question, recall the answer, then reveal and grade yourself.`;
...
function examVerdict(pct) {
  if (pct >= 90) return "Outstanding — you're well above the AZ-900 passing range.";
  if (pct >= 80) return "Strong work — keep drilling weak topics and you're set.";
  if (pct >= 70) return "Right around the AZ-900 pass line (700/1000). Review your misses below.";
